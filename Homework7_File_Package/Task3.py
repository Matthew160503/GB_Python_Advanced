...
def read_and_write_files(name_file_names: str,
    ...
    with (open(name_file_names, 'r', encoding='utf-8') as file_names,
          open(name_file_nambers, 'r', encoding='utf-8') as file_numbers):
...
if __name__ == "__main__":
    read_and_write_files(name_file_names='task2.txt',
                         name_file_nambers='task1.txt',
                         name_file_output='file_output.txt')